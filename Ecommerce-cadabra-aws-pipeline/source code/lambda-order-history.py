...
def lambda_handler(event, context):
    ...
    table = dynamo_db.Table('ecommerce-cadabra-ordershistorytable')
    decoded_record_data = [base64.b64decode(record['kinesis']['data']) for record in event['Records']]   # returns bytes
